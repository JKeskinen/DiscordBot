...
def _metrix_help_description() -> str:
    return (
        "!metrix\n\n"
        "Linkitä Metrix-tilisi ja seuraa omaa sekä muiden pelaajien "
        "rating-kehitystä, kilpailutuloksia ja parhaita kierroksia.\n\n"
        "Käyttö:\n"
        "📊 Metrix-komennot:\n\n"
        "Tietojen katselu:\n"
        "• !metrix - näytä omat Metrix-tiedot\n"
        "• !metrix @käyttäjä - näytä toisen käyttäjän tiedot\n\n"
        "Tilin linkitys:\n"
        "• !metrix [MetrixID] - linkitä oma Metrix-tili\n"
        ...
        "• Kilpailujen määrä ja viimeisin\n"
        "• Paras kierros ja päivämäärä\n"
